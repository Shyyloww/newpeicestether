...
class App(ctk.CTk):
    ...
    def populate_control_panel(self, parent, session_id):
        """IMPROVED: Redesigned with new feature set."""
        ...
        ctk.CTkLabel(custom_frame, text="Custom Actions", font=ctk.CTkFont(weight="bold")).grid(row=0, column=0, columnspan=2, pady=5)
